namespace ProjectName
    ...
    module Program =
        ...
        let main argv =
            ...
            let config = JObject.Parse(File.ReadAllText "./config/config.json")
            // Get login info
            ...
            let clientConfig = GuildedClientConfig(
            ...
            // Creates new client
            use client = new GuildedUserClient(email, password, clientConfig)
            ...
            client.Prepared.Add(fun arg -> printfn "I successfully logged in!\n - ID: %O\n - Name: %s" client.Me.Id client.Me.Username)
            // Start the bot
